...
![1564968784812](pic\1564968784812.png)
...
1.2 一旦数据源变更了，数据库的数据发生变化，脏数据就出现了。

​	解决： 1） DB变了，更新cache，并发高，可能会出现脏数据

​			线程A，更新DB后，还没更新Cache，切换到线程B，线程B，更新DB后，继续更新Cache，切换到线程A，继续更新Cache.

​		2）DB变了，删除Cache，在用户重新查询之后，填充新的Cache，没有脏数据。——facebook的做法



# Redis热点缓存重建时出现缓存穿透的问题。
...
![1564985435469](pic\1564985435469.png)
...
![1564987688819](pic\1564987688819.png)
